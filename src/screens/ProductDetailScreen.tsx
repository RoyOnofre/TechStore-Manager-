            ...
            <div className="flex flex-col md:flex-row gap-10">
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <div className="mt-10 grid grid-cols-2 gap-6">
                  ...
                  <div className="p-6 bg-background-dark/50 border border-primary/10 rounded-3xl">
                    <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Stock Actual</p>
                    <p className={`text-3xl font-black ${product.stock <= 10 ? 'text-amber-400' : 'text-primary'}`}>{product.stock} uds</p>
                  </div>
                </div>
              </div>
            </div>
